...
var staggeredListOptions=[];$('ul.staggered-list').each(function(i){console.log(i);var label='scrollFire-'+i;$(this).addClass(label);staggeredListOptions.push({selector:'ul.staggered-list.'+label,offset:200,callback:'showStaggeredList("ul.staggered-list.'+label+'")'});});console.log(staggeredListOptions);scrollFire(staggeredListOptions);
