...
this.$el.html(content);return this;},deleteUser:function(){this.model.destroy({url:'/api/user'});}});Sourcemash.Views.ItemsView=Backbone.View.extend({initialize:function(options){if(this.model){this.listenTo(this.model,'change',this.render);}
