<div class="container">
  <div class="row valign-wrapper">
      ...
      <span title="Mark as Read" class="mark-all-read col s2 m1">
        <i class="medium mdi-action-done-all tooltipped" data-position="bottom" data-tooltip="Mark All as Read"></i>
      </span>
